...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        epoch = vn.utils.loadCheckpoint(sess, ckpt_dir)
            ...
            if var_name == 'w1':
                ...
                for stage in range(num_stages):
                    for kidx in range(num_kernels):
                        ...
                        file_id = '%s/kernel_epoch%d_s%d_n%d.png' % (eval_output_dir, epoch, stage+1, kidx+1)
                        vn.visualization.saveSingleKernel(kernel, file_id)
